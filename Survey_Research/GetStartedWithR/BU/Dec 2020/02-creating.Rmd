...
![Click the small icon on the top right of the files pane to navigate to the files directory (such as a folder you created for your class or specific analysis).](images/GoToFileDirectory.png "Navigate to the files directory (such as a folder you created for your class or specific analysis")

Now our files tab shows the folder we want (in this example, it's a folder on the desktop).

![Now our files tab shows the folder we want (in this example, it's a folder on the desktop)](images/AtFileDirectory.png "Now our files tab shows the folder we want (in this example, it's a folder on the desktop)")

Here's the `More` directory, where `Set As Working Directory` can be selected.

![In the Files pane, select the More icon and then select Set as working directory.](images/SetWDGui.png "Using RStudio's GUI to set the working directory")
